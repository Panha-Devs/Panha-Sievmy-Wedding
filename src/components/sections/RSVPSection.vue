...
<template>
  <section id="rsvp" class="w-full max-w-3xl mt-32 text-left px-2">
    <h2 class="text-4xl md:text-6xl text-center font-khmer text-yellow-200">
      RSVP
    </h2>
    <form @submit.prevent="submit(props.email, props.modelValue)" class="mt-8 grid grid-cols-1 gap-3 md:gap-4 text-black">
    ...
    <p class="mt-3 text-yellow-300 font-khmer-kh text-center">
